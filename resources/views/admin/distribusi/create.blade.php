...
@section('content')
<h2 style="margin-bottom: 1rem; color: #14532D;">Tambah Distribusi</h2>
...
<div style="background-color: #FAF9F6; padding: 2rem; border-radius: 12px; max-width: 700px;">
    <form action="{{ route('admin.distribusi.store') }}" method="POST">
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <input type="date" name="tanggal_distribusi" id="tanggal_distribusi" value="{{ old('tanggal_distribusi') }}" required
                   style="width: 100%; padding: 0.5rem; border: 1px solid #A3B18A; border-radius: 6px; background-color: #ffffff;">
